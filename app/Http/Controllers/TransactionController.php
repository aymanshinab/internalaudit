...
*/
    ...
    public function adminsearch(Request $request)
    {
        ...
        if ($request['search'] == 1) {
            ...
            $filterTransactions = Transaction::where('type',  $search)->paginate(5);
        } elseif ($request['search'] == 3) {
            $filterTransactions = Transaction::where('year',  $search)->paginate(5);
        } elseif ($request['search'] == 4) {
            $filterTransactions = Transaction::where('month',  $search)->paginate(5);
        } elseif ($request['search'] == 5) {
            $filterTransactions = Transaction::where('management_id',  $search)->paginate(5);
        }
